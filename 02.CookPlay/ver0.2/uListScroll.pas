...
type
  TPaintPrcedure = procedure of object;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          aCommentIcon.Bitmap := CM.imagelistGlobal.Bitmap(TSizeF.Create(26,26), 1);
          ...
          aRecommendationIcon.Bitmap := CM.imagelistGlobal.Bitmap(TSizeF.Create(26,26), 0);
