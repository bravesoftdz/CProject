...
type
  ...
  TframeScale = class(TFrame)
    ...
    procedure imgPriorIngredientClick(Sender: TObject);
    procedure imgNextIngredientClick(Sender: TObject);
  private
...
procedure TframeScale.imgPriorIngredientClick(Sender: TObject);
begin
  FloatAnimationLeftIngredient.Start;
end;

procedure TframeScale.imgNextIngredientClick(Sender: TObject);
begin
