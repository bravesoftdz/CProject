...
type
  ...
  public
    { Public declarations }
    procedure Init(aRecipeSerial: LargeInt; ACallbackBoolRefFunc: TCallbackBoolRefFunc);
...
procedure TfrmComment.Init(aRecipeSerial: LargeInt; aCallbackBoolRefFunc: TCallbackBoolRefFunc);
begin
