...
begin
  ...
  dbWeightString := ItemWeightValue.ToString + GetWeightUnitString(ItemUnit);
  ...
  begin
    if (userWeightString = dbWeightString) then
      ...
      result := Title + ' ' + userWeightString + '(' + ItemWeightValue.ToString + GetWeightUnitString(ItemUnit) + ')'
  end
  else
    result := Title + ' ' + userWeightString;
end;
