object dmDB: TdmDB
  ...
  object sqlMakingLevel: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'MakingLevel'#39' order by' +
        ' seq')
    Left = 44
    Top = 502
  end
  ...
  object sqlMakingTime: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'MakingTime'#39' order by ' +
        'seq')
    Left = 146
    Top = 506
  end
  ...
  object sqlPictureType: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'PictureType'#39' order by' +
        ' seq')
    Left = 272
    Top = 506
  end
  ...
  object sqlIngredientType: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'IngredientType'#39' order' +
        ' by seq')
    Left = 394
    Top = 506
  end
  ...
  object sqlMethodType: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'MethodType'#39' order by ' +
        'seq')
    Left = 506
    Top = 510
  end
  ...
  object sqlItemType: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from Category where categorytype='#39'ItemType'#39' order by se' +
        'q')
    Left = 612
    Top = 508
  end
