...
procedure TfrmExplain.btnClearLinkClick(Sender: TObject);
begin
  frmRecipe.memMethodLinkedRecipe.AsLargeInt := -1;
end;
...
begin
  if frmRecipe.memMethodDescription.AsString.IsEmpty then
  begin
...
procedure TfrmExplain.Button1Click(Sender: TObject);
begin
  frmRecipe.memMethodRecipeIngredient_Serial.AsLargeInt := _type.notLinked;
end;
