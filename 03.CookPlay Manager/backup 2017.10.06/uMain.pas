...
type
  TfrmMain = class(TForm)
    ...
    cxgRecipeIngredientWeightType: TcxGridDBColumn;
    ...
    cxgRecipeIngredientPictureRectangle: TcxGridDBColumn;
    cxgRecipeIngredientPictureSquare: TcxGridDBColumn;
    ...
    cxgRecipeMethodRecipeIngredient_Serial: TcxGridDBColumn;
    cxgRecipeMethodMethodType: TcxGridDBColumn;
    cxgRecipeMethodWeightType: TcxGridDBColumn;
    cxgRecipeMethodWeightValue: TcxGridDBColumn;
    cxgRecipeMethodTimeType: TcxGridDBColumn;
    cxgRecipeMethodTimeValue: TcxGridDBColumn;
    cxgRecipeMethodTemperatureType: TcxGridDBColumn;
    cxgRecipeMethodTemperatureValue: TcxGridDBColumn;
    cxgRecipeMethodLinkedRecipe: TcxGridDBColumn;
    ...
    cxLabel1: TcxLabel;
    cxgRecipeMethodExplainSeq: TcxGridDBColumn;
